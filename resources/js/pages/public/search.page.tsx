...
import { Search, SortAsc, Clock, BookOpen, Loader2, TrendingUp } from 'lucide-react';
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <AnimatePresence>
                        {(courses.length > 0 || loading) && (
                            ...
                            >
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                                        ...
                                        {!loading && (
                                            ...
                                            >
                                                ...
                                                {searchStats.searchTime > 0 && (
                                                    <span className="text-gray-400">en {searchStats.searchTime}ms</span>
                                                )}
                                                {realTimeSearch && (
                                                    <motion.span 
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        >
                                            ...
                                            <select 
                                                ...
                                                className="text-sm border border-gray-200 rounded-lg px-3 py-2 bg-white focus:border-primary focus:outline-none transition-colors"
                                            >
