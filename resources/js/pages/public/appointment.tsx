        ...
        <DefaultLayout>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Pourquoi prendre rendez-vous ?</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">Analyse de vos besoins et recommandations sur mesure pour votre parcours de formation.</p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">Information complète sur les modalités, financement et démarches d'inscription.</p>
                        </div>
            ...
            <section className="py-12 bg-blue-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Vous préférez nous contacter directement ?</h2>
                    <p className="text-gray-600 mb-8">Notre équipe est à votre disposition pour répondre à toutes vos questions.</p>
