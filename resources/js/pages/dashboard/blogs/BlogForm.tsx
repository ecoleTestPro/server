...
export const BLOG_FORM_DEFAULT_VALUES: BlogForm = {
    title: '',
    slug: '',
    excerpt: '',
    description: '',
...
export const BlogForm = ({ blog = null, categories = [], onCancel }: BlogFormProps) => {
    ...
    const { data, setData, post, processing, errors, reset } = useForm<BlogForm>(BLOG_FORM_DEFAULT_VALUES);
        ...
        <div className="flex flex-col gap-4 rounded-xl p-4 bg-white dark:bg-gray-800">
            ...
            <form className="space-y-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button type="button" onClick={onCancel} className="px-4 py-2 bg-gray-300 dark:bg-gray-600 rounded-md">
                        {t('Cancel')}
                    </button>
                </div>
            </form>
