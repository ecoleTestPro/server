            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Vue calendrier de tous les rendez-vous</p>
                    </div>
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>Cliquez sur une date pour voir les détails</CardDescription>
                            </div>
                        ...
                        {selectedDate && (
                            <div className="space-y-4 max-h-96 overflow-y-auto">
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                {appointment.description && (
                                                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">{appointment.description}</p>
                                                )}
                                            </div>
                                        </div>
                                    </motion.div>
                                ...
                                {getAppointmentsForDay(selectedDate.getDate()).length === 0 && (
                                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">Aucun rendez-vous ce jour</div>
                                )}
                            </div>
                        )}
                    </DialogContent>
