...
export function BtnHoverEffect({
    className,
    text,
    icon,
    iconPosition = 'left',
    ...
    return (
        <button
            className={`cursor-pointer group relative inline-flex h-10 items-center justify-center overflow-hidden rounded-md border border-primary font-medium ${className || ''}`}
        >
            {/* Normal State */}
