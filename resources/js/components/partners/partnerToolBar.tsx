...
export default function PartnerToolBar({ FormComponent, open, setOpen }: IPartnerToolBarProps) {
    ...
    return (
        <div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="mt-2 flex justify-end space-x-2">
                        <Button
                            ...
                            aria-label={t('Add partner', 'Ajouter un partenaire')}
                        >
            ...
            {open && FormComponent && (
                <Drawer title={t('Partners.add', 'Ajouter un partenaire')} open={open} setOpen={setOpen && setOpen} component={FormComponent} />
            )}
        </div>
    );
}
