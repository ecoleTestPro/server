...
import { Eye, HelpCircle, MessageCircle, HelpCircle as QuestionMarkCircle } from 'lucide-react';
                        ...
                        <TooltipContent>
                            <p className="max-w-xs">
                                {initialData?.id
                                    ...
                                    : 'Créez une nouvelle question-réponse pour aider vos visiteurs à trouver rapidement les informations.'}
                            </p>
                        </TooltipContent>
                    </Tooltip>
                </div>
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    La question que vos visiteurs posent fréquemment. Formulez-la de manière claire et naturelle.
                                </p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    La réponse détaillée à la question. Utilisez l'éditeur riche pour formater le texte, ajouter des liens et
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    Choisissez si cette FAQ doit être visible sur votre site web ou resté cachée pour modification ultérieure.
                                </p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                ...
                <div className="flex justify-between items-center pt-6 border-t border-gray-200">
                    ...
                    <Button type="submit" disabled={processing} className="bg-primary hover:bg-primary/90 px-8">
                        {processing ? (
                            ...
                            t('Update FAQ', 'Modifier la FAQ')
                        ) : (
                            t('Create FAQ', 'Créer la FAQ')
                        )}
                    </Button>
                </div>
            </form>
