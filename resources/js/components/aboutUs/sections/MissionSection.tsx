...
export default function MissionSection() {
    return (
        <MotionSection className={`body-font ${CLASS_NAME.bgGray}`} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
            <div className="py-8 md:py-12 lg:py-16 xl:py-20">
                <div className="relative z-[1] container mx-auto px-4 sm:px-6 lg:px-8 2xl:max-w-[1320px]">
                    ...
                    <motion.div className="text-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
                        {/* Titre de la section */}
                        ...
                        <p className="!mb-6 leading-relaxed text-gray-700 dark:text-gray-300 text-base md:text-lg max-w-4xl mx-auto">
                            ...
                            certifiantes, sur-mesure et alignées sur les standards internationaux. Garantir que chaque projet digital repose sur des
                            fondations solides, validées et mesurables. Grâce à une approche rigoureuse, des outils éprouvés et une pédagogie adaptée
                            aux réalités du terrain, TestPro transforme les enjeux de qualité en leviers de performance durable.
                        </p>
                    </motion.div>
                </div>
            </div>
