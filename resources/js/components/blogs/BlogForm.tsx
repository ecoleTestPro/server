...
import { BookOpen, Eye, FileText, Globe, HelpCircle, PlusCircleIcon, Tag as TagIcon } from 'lucide-react';
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p className="max-w-xs">
                                {blog
                                    ? 'Modifiez les informations de votre article et sauvegardez les changements.'
                                    : 'Créez un nouvel article avec titre, contenu riche, catégorie et tags pour engager votre audience.'}
                            </p>
                        </TooltipContent>
                    </Tooltip>
                </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('Title', 'Titre')} *</label>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button type="button" className="text-gray-400 hover:text-gray-600 transition-colors">
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    Le titre de votre article. Il apparaîtra comme titre principal sur votre site web. Soyez descriptif et engageant
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('Category', 'Catégorie')} *</label>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button type="button" className="text-gray-400 hover:text-gray-600 transition-colors">
                                    <HelpCircle className="h-4 w-4" />
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    La catégorie aide à organiser vos articles et permet aux visiteurs de naviguer plus facilement dans votre contenu.
                                    Choisissez la catégorie la plus appropriée ou créez-en une nouvelle.
                                </p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('Tags', 'Tags')}</label>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button type="button" className="text-gray-400 hover:text-gray-600 transition-colors">
                                    <HelpCircle className="h-4 w-4" />
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    Les tags sont des mots-clés qui aident à catégoriser et retrouver vos articles. Utilisez des termes pertinents
                                    comme "technologie", "formation", "actualités". Tapez et appuyez sur Entrée pour ajouter un tag.
                                </p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                    <TagInput tags={tags} onChange={setTags} placeholder="Ex: formation, e-learning, nouveautés" />
                    <p className="text-xs text-gray-500 mt-1">Les tags améliorent la recherche et l'organisation de vos articles</p>
                </div>

                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <FileText className="h-4 w-4 text-blue-600" />
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">{t('Content', 'Contenu')} *</label>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button type="button" className="text-gray-400 hover:text-gray-600 transition-colors">
                                    <HelpCircle className="h-4 w-4" />
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    Le contenu principal de votre article. Utilisez l'éditeur riche pour formater le texte, ajouter des liens, des
                                    images et structurer votre contenu de manière attrayante.
                                </p>
                            </TooltipContent>
                        </Tooltip>
                    </div>
                ...
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>
                                <p className="max-w-xs">
                                    Choisissez si cet article doit être immédiatement visible sur votre site (Publié) ou resté en mode brouillon pour
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <Switch checked={data.status} onCheckedChange={(checked) => setData('status', checked)} id="publication-status" />
                ...
                <div className="flex justify-between items-center pt-6 border-t border-gray-200">
                    <Button type="button" onClick={() => router.visit(route('dashboard.blogs.index'))} variant="outline" className="px-6">
                        {t('Cancel', 'Annuler')}
                    </Button>
                    <Button type="submit" disabled={processing} className="bg-blue-600 hover:bg-blue-700 px-8">
                        {processing ? (
                            ...
                            t('Update Article', "Modifier l'article")
                        ) : (
                            t('Create Article', "Créer l'article")
                        )}
                    </Button>
                </div>
            </form>
