...
import { FaMapMarkerAlt, FaCalendarAlt, FaBriefcase, FaEuroSign } from 'react-icons/fa';
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
                            {job.created_at && (
                                <div className="flex items-center gap-2">
                                    ...
                                    <span><strong>Publié le:</strong> {job.created_at}</span>
                                </div>
                            )}
                            ...
                            {job.expires_at && (
                                <div className="flex items-center gap-2">
                                    ...
                                    <span><strong>Expire le:</strong> {job.expires_at}</span>
                                </div>
                            )}
                        </div>
                    </div>
