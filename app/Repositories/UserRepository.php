...
class UserRepository extends Repository
{
    ...
    /**
     * Stores a new user record based on a student registration request.
     *
     * This function handles the storage of a user's profile picture if provided, 
     * or assigns a default image if not. It creates a new user record with 
     * the provided details from the student registration request.
     *
